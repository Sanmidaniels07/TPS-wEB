    ...
    <header className="relative z-40">
      <nav className='flex items-center justify-between py-5 px-7 md:p-7 bg-neutral-700 text-white hover:bg-black border-b-2 border-b-primary'>
        ...
        <ul className='hidden items-center gap-8 lg:flex'>
          <li onMouseEnter={() => setServiceOpen(true)} onMouseLeave={() => setServiceOpen(false)}>
            <a href="#" className='group flex items-center gap-1 text-base font-medium text-white hover:text-primary transition-colors'>
              Services
            </a>
          </li>
          <li onMouseEnter={() => setChallengeOpen(true)} onMouseLeave={() => setChallengeOpen(false)}>
            <a href="#" className='text-sm font-medium text-white hover:text-primary transition'>Challenges</a>
          </li>
          <li>
            <a href="#" className='text-sm font-medium text-white hover:text-primary transition'>About</a>
          </li>
          <li>
            <a href="#" className='text-sm font-medium text-white hover:text-primary transition'>Success stories</a>
          </li>
          <li>
            <a href="#" className='text-sm font-medium text-white hover:text-primary transition'>Knowledge base</a>
          </li>
          <li>
            <a href="#" className='text-sm font-medium text-white hover:text-primary transition'>Blog</a>
          </li>
          <li>
            <a href="#" className='text-sm font-medium text-white hover:text-primary transition'>FAQs</a>
          </li>
        </ul>
      ...
      {serviceOpen && <ServiceDropdown open={setServiceOpen} />}
      {challengeOpen && <ChallengeDropdown open={setChallengeOpen} />}
    </header>
  )
}
...
const MobileNav = ({close}) => {
  ...
  return (
    <div className="bg-[#1e1e1e] w-full min-h-screen fixed top-0 left-0 right-0 lg:hidden transition-all">
...
const ServiceDropdown = () => {
  return (
    <div className="w-full bg-white z-20 py-20">
      <div className="w-4/5 mx-auto flex items-center flex-wrap gap-x-10 gap-y-12">
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          <span className='text-primary100'>
            <BsCloudDownloadFill size={30} />
          </span>
          <h4 className='text-xl text-slate-900 font-bold'>Cloud Solutions</h4>
          <p className='text-base text-slate-700 font-normal'>A wide range of cloud solutions for business</p>
        </div>

        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          <span className='text-primary100'>
            <BiSolidShield size={30} />
          </span>
          <h4 className='text-xl text-slate-900 font-bold'>Cyber Security Services</h4>
          <p className='text-base text-slate-700 font-normal'>Trust your IT with Experts in deliverying IT support excellence.</p>
        </div>
        ...
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          ...
          <h4 className='text-xl text-slate-900 font-bold'>Communications</h4>
          <p className='text-base text-slate-700 font-normal'>Bespoke business communication systems.</p>
        </div>
        ...
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          ...
          <h4 className='text-xl text-slate-900 font-bold'>IT Support and Consultancy Services</h4>
          <p className='text-base text-slate-700 font-normal'>Expert IT services when you need it most.</p>
        </div>
        ...
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          ...
          <h4 className='text-xl text-slate-900 font-bold'>Backup and Recovery</h4>
          <p className='text-base text-slate-700 font-normal'>Leading backup and recovery services for businesses.</p>
        </div>
      </div>
    </div>
  )
    ...
    <div className="w-full bg-white z-20 py-20">
      <div className="w-4/5 mx-auto flex items-center flex-wrap gap-x-10 gap-y-12">
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          ...
          <h4 className='text-xl text-slate-900 font-bold'>Old, Slow and Useless</h4>
        ...
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          ...
          <h4 className='text-xl text-slate-900 font-bold'>IT and your Business Ambitions</h4>
          <p className='text-base text-slate-700 font-normal'>Ensure your business objectives align with your IT strategy.</p>
        </div>
        ...
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          ...
          <p className='text-base text-slate-700 font-normal'>Don't be caught offguard by unforeseen circumstances.</p>
        </div>
        ...
        <div className="flex flex-col items-start basis-80 space-y-3 cursor-pointer">
          ...
          <p className='text-base text-slate-700 font-normal'>
            IT security is often an afterthought, find out why it matters.
          </p>
        </div>
