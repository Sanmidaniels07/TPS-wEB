      ...
      <nav className='flex items-center justify-between py-5 px-7 md:p-7 bg-transparent text-white hover:bg-black border-b-2 border-b-primary h-36'>
        ...
        <ul className="hidden lg:flex items-center gap-6">
          {
            navlinks.map((items, index) => {
              ...
              const { link, submenu, sublink, route } = items;
              return (
                <li className='group' key={index}>
                  {
                    submenu ? <div>
                      ...
                      :
                      <Link to={route}  className='text-white font-medium hover:text-primary100 text-base'>
                        {link}
                      </Link>
                  }
                </li>
        ...
        <div className="flex items-center gap-6">
          <div className="hidden sm:flex items-center ml-auto lg:ml-0">
            ...
            <a href="https://jdjjsk.com" className="border-2 border-primary100 px-5 py-2 rounded-3xl text-sm text-white lg:text-sm hover:bg-primary100">
              Get in touch
            </a>
          </div>
          ...
          </div>
          {
            dropdown && (
              <ul className={`${dropdown} ? 'flex flex-col space-y-5 my-6 mx-6' : 'hidden'`}>
                <li>
                  <a href="https://jdjjsk.com" className='flex items-center gap-4 text-base font-normal'>
          ...
          </div>
          {
            dropdown && (
              <ul className={`${dropdown} ? 'flex flex-col space-y-3 my-6 mx-6' : 'hidden'`}>
                <li>
                  <a href="https://jdjjsk.com">Old, Slow and Useless!</a>
                </li>
                <li>
                  <a href="https://jdjjsk.com">IT and ROI</a>
                </li>
                <li>
                  <a href="https://jdjjsk.com">IT and your Business Ambitions</a>
                </li>
                <li>
                  <a href="https://jdjjsk.com">Disaster Recovery! What's that?</a>
                </li>
                <li>
                  <a href="https://jdjjsk.com">Does IT Security Matter? The Importance of IT Security</a>
                </li>
                <li>
                  <a href="https://jdjjsk.com">Small Issues which Create Big Problems</a>
                </li>
              </ul>
            )
          }
            ...
            link.map((item, index) => {
              ...
              return (
                <li key={index} className='basis-[22rem]'>
                  <a href="http:s" className='flex flex-col items-start space-y-3'>
                    {
